...
export const agentControlPlane: DiagramSpec = {
  ...
  nodes: [
    { id: 'registry', label: 'Registry + inventory', sublabel: 'agents · versions · tools · policy', x: 1, y: 1, variant: 'primary', tag: 'system of record' },
    ...
    { id: 'killswitch', label: 'Kill-switch service', sublabel: 'agent · tool · tenant · platform', x: 1, y: 3, variant: 'ghost', tag: 'four grains' },
  ],
  edges: [
