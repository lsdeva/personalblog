...
Before the scroll-through, here is the whole system in one continuous trace — a single agent action walking all eleven processes end-to-end, every governed event dropping into the audit chain as it passes.
